...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_root", type=str, default="./UBC_fashion/test")
    ...
    if args.save_dir is None:
        save_dir = args.video_root + "_dwpose_keypoints"
    else:
    ...
    process_batch_videos(video_mp4_paths, detector, args.video_root, save_dir)
    print('all done!')