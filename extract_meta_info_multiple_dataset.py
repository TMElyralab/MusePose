...
# python tools/extract_meta_info.py --video_dirs /path/to/video_dir --dataset_name fashion
parser = argparse.ArgumentParser()
parser.add_argument("--video_dirs", type=str, default=[
    "./UBC_fashion/test",
    # "path_of_dataset_1",
    # "path_of_dataset_2",
    ])
...
for dataset_path in args.video_dirs:
    video_mp4_paths = set()
